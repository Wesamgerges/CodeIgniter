...
/**
   ...
   /**
    * ChurchMangementSystem easy_attendance_AR
    * 
    *
    * Easy attendance AR
    * 
        ...
        <div class = "element" style = "width: 30px;height: 100%;" align = "center">
            <table>
                ...
                for ($i = 0; $i < 28; $i++) {
                    ...
                    <tr>
                        <td>
                            <a href="#<?php echo $AR_charchters[$i]; ?>"> <?php echo $AR_charchters[$i]; ?> </a>
                        </td>
                    </tr>
<?php } ?>
            </table>
        ...
        <div style=" width : 85%" >
            <table align="center" cellpadding="3px" width="50%" >
                ...
                <?php
                $i = 1;$j=0;
                $CharacterAnchor = $AR_charchters[0];
                foreach ($persons as $person) {$j++;
                    if ($person->native_name == "")
                        continue;

                    if ($CharacterAnchor != $person->native_name[0]){
                     echo $CharacterAnchor;
                        $CharacterAnchor = $person->native_name[0];
                     echo $CharacterAnchor;
                     echo $j;
                    }
                    ?>
                    <tr>    	
                        <td >
                            <div class='anchor rounded <?php if (( $i++) % 2 == 0) echo " "; if ($person->weeklyMeetingId != NULL) echo " select " ?>' align="center" id = "<?php echo $person->Id; ?>">
                                <a  name="<?php echo $CharacterAnchor; ?>" > 
                                    <?php echo $person->native_name; // . " ".$person->LastName; ?>
                                </a>
                            </div>           
                        </td>          
                    </tr>
        ...
        <script>
            ...
            $("document").ready(function(){
                ...
                $(".anchor").click(function(){			
                    ...
                    $.post("SaveAttendance2.php",{id:$(this).attr("id"), weeklyId:<?php echo 1; //$currentMeetingId;  ?>},function (d){
